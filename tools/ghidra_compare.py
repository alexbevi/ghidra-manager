...
This is an internal tool invoked by ghidra-manager.sh. The manager remains the
supported user-facing entrypoint and provisions the Python runtime with uv.
"""
